...
@JvmOverloads constructor(
    ...
    @JvmOverloads
    fun ReInit(
        dstream: java.io.Reader, startline: Int = 1,
        startcolumn: Int = 1, buffersize: Int = 4096
    ) {
        inputStream = dstream
        line = startline
    ...
    constructor(
        ...
        if (encoding == null) java.io.InputStreamReader(dstream) else java.io.InputStreamReader(dstream, encoding),
        startline,
        startcolumn,
        buffersize
    )
    ...
    fun ReInit(
        ...
        ReInit(
            if (encoding == null) java.io.InputStreamReader(dstream) else java.io.InputStreamReader(
                dstream,
                encoding
    ...
    fun ReInit(
        ...
        ReInit(java.io.InputStreamReader(dstream), startline, startcolumn, buffersize)
    }
